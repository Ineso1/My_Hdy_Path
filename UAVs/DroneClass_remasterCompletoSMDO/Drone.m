classdef Drone < DroneDataExtention
    ...
    methods
        function obj = Drone(mass, Jxx, Jyy, Jzz, q, x0, y0, z0, dt)
            ...
            obj.dx_hat_SMC_trans = [0; 0; 0; 0; 0; 0;];
        ...
        function obj = updateDroneDataExtention(obj)
            ...
            obj.dx_stateSMC_trans(:, obj.iterations + 1) = obj.dx_hat_SMC_trans + [0; 0; 0; 0; 0; obj.g];
        ...
        function obj = calculateStateSMC_trans(obj)
            x_t = [obj.p; obj.dp];
            e_smc_pos = obj.x_hat_SMC_trans(1:3) - x_t(1:3);     % Position estimation error
            e_smc_vel = obj.x_hat_SMC_trans(4:6) - x_t(4:6);     % Velocity estimation error
            v_injection = -obj.Gamma_SMC_trans * sign(e_smc_pos) - obj.k_d_SMC_trans * e_smc_vel;
            obj.dx_hat_SMC_trans(1:3) = obj.x_hat_SMC_trans(4:6);     
            obj.dx_hat_SMC_trans(4:6) = v_injection;
            obj.x_hat_SMC_trans = obj.x_hat_SMC_trans + obj.dt * obj.dx_hat_SMC_trans;
        end
