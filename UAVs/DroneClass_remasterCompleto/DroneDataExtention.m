classdef DroneDataExtention
    ...
    methods
        ...
        function plotObserverStates_rot(obj)
            ...
            grid on;
            hold on;
            plot(obj.time_array, obj.dx_state_rot(4,:), 'r--o', 'DisplayName', 'Raw State domegaX');
            ...
            grid on;
            hold on;
            plot(obj.time_array, obj.dx_state_rot(5,:), 'r--o', 'DisplayName', 'Raw State domegaY');
            ...
            grid on;
            hold on;
            plot(obj.time_array, obj.dx_state_rot(6,:), 'r--o', 'DisplayName', 'Raw State domegaZ');
